...
export default function Anamnese() {
    ...
    function buscaAtendimento() {
        ...
        if (idAtendimento !== "") {
            ...
            let url = process.env.REACT_APP_API_URL + process.env.REACT_APP_API_IDATD + "/" + idAtendimento;
            ...
            req.onload = function () {
                if (req.status === 200) {
                    ...
                    document.getElementById('recepcionista').value = puxapaciente.usuarioIdFunc;
                }
...
Comorbidades: 
    ...
    const handlePacienteAname = async (e) => {
        ...
        try {
            ...
            await axiosPrivate.put(process.env.REACT_APP_API_SALANAM,
                JSON.stringify({
            ...
            <div className="me-3">
                <form onSubmit={handlePacienteAname}>
                    ...
                    <div className="w-100 d-inline-flex flex-row justify-content-start align-items-start">
                        ...
                        <div className="form-floating mb-3 me-3 w-20">
                            <input type="text" ref={medicoRef} value={auth.nome} className="form-control w-100" id="nomeMedico" autoComplete='off' placeholder="Example input" readOnly />
